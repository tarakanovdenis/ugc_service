...
if __name__ == '__main__':
    ...
    # В соответствии с https://www.psycopg.org/docs/usage.html#with-statement
    # начиная с версии 2.5, psycopg2’s connections и cursors являются
    # контекстными менеджерами и могут быть использованы с with.
    # Поэтому для соединения с базой данных PostgreSQL contextlib.closing()
    # не использовался.
